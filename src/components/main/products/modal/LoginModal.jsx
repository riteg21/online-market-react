...
export const LoginModal = ({ onClose }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-60 bg-black/10 backdrop-blur-sm flex items-center justify-center">
      <div className=" relative w-[50%] max-w-xl bg-white text-black p-2 rounded-2xl shadow-lg animate-fadeIn">
        <button
          type="button"
        ...
        <h1 className="text-3xl font-black text-orange-500 flex justify-center mb-7 mt-10">
          Welcome Back
        </h1>
